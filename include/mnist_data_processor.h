...
#define MNIST_IMG_SIZE (MNIST_IMG_DIM * MNIST_IMG_DIM) // 28 x 28 = 784 bytes

#define MNIST_LABEL_SIZE 1 //  1 byte label

#define MNIST_SIZE_IMG_TRAIN (MNIST_TRAIN_SIZE * MNIST_IMG_SIZE)

#define MNIST_SIZE_LABEL_TRAIN (MNIST_TRAIN_SIZE * MNIST_LABEL_SIZE)
